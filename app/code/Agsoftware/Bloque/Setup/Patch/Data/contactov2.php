...
namespace Agsoftware\Bloque\Setup\Patch\Data;

class contactov2 implements \Magento\Framework\Setup\Patch\DataPatchInterface
{
    /**
    ...
    { 
        ...
        $block_data_head= [
            ...
            'identifier' => 'mision',
            'is_active' => 1,
            'content' => file_get_contents(__DIR__.'/html/bloque.html'),
        ];
